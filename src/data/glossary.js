const glossary = [
  ...
  },
  {
    ...
    en: "Silver",
    category: "コモディティ",
    definition: "銀（ぎん）の先物価格。金と同様に安全資産として注目されるが、工業用途（電子部品・太陽光パネル）も多く景気動向にも敏感に反応する。金より価格変動が大きい傾向がある。"
  },
  {
    name: "プラチナ",
    en: "Platinum",
    category: "コモディティ",
    definition: "白金（はっきん）の先物価格。自動車の排気ガス触媒として需要が高く、金よりも希少。電気自動車の普及により自動車向け需要が減少傾向にあるが、水素燃料電池向けの需要増に注目が集まる。"
  },
  {
    name: "原油（WTI）",
    en: "WTI Crude Oil",
